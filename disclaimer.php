...
$title = "ÜBA - IHK Bildungshaus Region Stuttgart - Disclaimer";
$buffer = preg_replace('/(<title>)(.*?)(<\/title>)/i', '$1' . $title . '$3', $buffer);
echo $buffer;
?>
<div class="container py-3">
    <div style="min-height: 80vh;">
        <h1 class="display-3 text-center mb-3">Disclaimer</h1>
        ...
        <p>Quelle: <a href="https://www.e-recht24.de" target="_blank" class="slink">https://www.e-recht24.de</a></p>
    </div>
</div>
